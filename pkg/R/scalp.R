scalp <-
  function(erpdfs, smo=NULL, layout=1, ylims="auto", yrev=TRUE, startmsec=NULL, endmsec=NULL, lwd=1, lty=1, color.list=c("blue", "red", "darkgreen"), legend=F, legend.lab="default", t.axis=NULL, scalp.array=NULL){
