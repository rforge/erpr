erp.cor <-
  function(base, numbers, electrode, erplist=NULL,startmsec=NULL, endmsec=NULL, external=NULL, smo=NULL, alpha=0.05, method = c("pearson", "kendall", "spearman"),  sig=NULL,  main=electrode, ...) {
