#datall=erp.fun.cycle(bases=c("Exp1_word_subj", "Exp1_nonword_subj"), numbers=1:20, erp.fun=erp.mean, conditions.names=c("word", "nonword"), erplist=ERPsets, intervals.var=TRUE, intervals=list(c(100, 200), c(300, 500)))


erp.fun.cycle<-function(bases=NULL, numbers=NULL, erp.fun=NULL, intervals=NULL, conditions.names=NULL, erplist=NULL, startmsec=NULL, endmsec=NULL, others=NULL, intervals.var=TRUE, ...){
  ...
  if (is.null(startmsec)|is.null(endmsec)){
    stop("you must specify starmsec and endmsec of your data.", call.=F)
  }
